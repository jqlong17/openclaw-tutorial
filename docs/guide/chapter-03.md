...
| **成本敏感** | MiniMax 包月 或 DeepSeek | 包月无限调用，或按量价格较低 |
| **通用场景** | GPT-5 或 Claude 4 | 综合能力最强，但成本较高 |

**成本等级参考**（相对对比，非精确价格）：

| 成本等级 | 模型 | 特点 |
|----------|------|------|
| **高** | GPT-5、Claude 4 | 能力最强，价格较高 |
| **中** | Gemini 3 Pro、Kimi K2.5 | 能力优秀，价格适中 |
| **低** | MiniMax 包月、DeepSeek V3 | 性价比高，适合高频调用 |

**建议**：
- 生产环境先用 **MiniMax 包月** 或 **DeepSeek** 降低成本
- 需要最强能力时切换到 **GPT-5** 或 **Claude 4**
- 多模态场景首选 **Gemini 3 Pro**
